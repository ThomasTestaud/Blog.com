<div class="chat-card">
    ...
    <div class="message-area">
        <?php $liveChat->getMessagesFromRoom("1"); ?>
    </div>
    <script type="text/javascript">
        document.querySelector('.message-area').style.height = "400px";
        document.querySelector('.message-area').scrollTop = 3000000;
    </script>
    <div class="chatMessage">
        <form method="post">
            <div class="modify-input">
                <input type="text" name="chatMessage" placeholder="Ecrivez votre message ici..."/>
            </div>
