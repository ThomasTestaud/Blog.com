        ...
        <p id="welcome" style="margin-right: 10px;">Bonjour <?php echo $_SESSION['psedo']; ?> !</p>
        <nav>
            <?php if(isset($_SESSION['psedo'])): ?>
                <div class="icone">
                    <a href="?page=chat">
            ...
            <?php endif ?>
            <div class="icone">
                <a href="?page=profil&psedo=<?php echo $_SESSION['psedo']; ?>">
